  ...
  return (
    <nav className="bg-[#00142B] shadow-lg py-4 w-screen md:w-full lg:w-full xl:w-full">
      <div className="max-w-7xl mx-auto px-4 lg:px-0">
        <div className="flex justify-between">
          <div className="flex space-x-4">
            ...
            <div className='flex flex-row lg:w-xl md:w-52 sm:w-0 xl:w-4xl'></div>
            ...
            <div className="hidden md:flex items-center space-x-1">
              <Link href="mailto:hello@agntcy.org" legacyBehavior>
                  <a className="flex-shrink-0 text-xl font-bold text-[#FBAB2C] hover:text-orange-500 border p-3 rounded-4xl">Join us</a>
              </Link>
            </div>
          </div>
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden my-6`}>
        ...
        <div className='mt-3'>
        <Link href="mailto:hello@agntcy.org" legacyBehavior className=''>
            <a className="flex-shrink-0 py-2 px-4 ml-4 text-sm font-bold text-[#FBAB2C] hover:text-orange-500 border rounded-4xl">Join us</a>
        </Link>
        </div>
      </div>
    </nav>
