  ...
  return (
    <nav className="bg-[#00142B] shadow-lg py-4">
            ...
            <div className="absolute right-28 lg:right-10 md:right-10">
              <div className="hidden md:flex items-center space-x-1">
                ...
                <Link
                  ...
                  legacyBehavior
                >
                  <a className="flex-shrink-0 text-xl font-bold text-[#FBAB2C] hover:text-orange-500 border p-3 rounded-3xl">
                    Join us
                  </a>
                </Link>
              </div>
      ...
      >
        {navItems.map((item) => (
          <Link key={item.name} href={item.href} legacyBehavior>
            <a className="block py-1 px-4 text-sm text-[#FBAB2C] hover:bg-gray-200">
              {item.name}
            </a>
          </Link>
        ))}
        <div className="mt-3">
          <Link
            ...
            className=""
          >
            <a className="flex-shrink-0 py-2 px-4 ml-4 text-sm font-bold text-[#FBAB2C] hover:text-orange-500 border rounded-3xl">
              Join us
            </a>
          </Link>
        </div>
